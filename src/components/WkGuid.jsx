...
const WkGuid = () => {
  return (
    <>
    <div className='flex flex-col lg:gap-30 lg:flex-row justify-between items-center mx-7  md:py-16'>
      {/* Text Content */}
      <div className='w-full lg:w-1/2 flex flex-col items-start mb-8 lg:mb-0 lg:pr-8 order-2 lg:order-1'>
        ...
        <h2 className='text-5xl   font-One text-white text-left mb-6'>
         ...
         {/* Image */}
      <div className='w-full lg:w-1/2 flex justify-center mt-2 mb-5'>
        <img
