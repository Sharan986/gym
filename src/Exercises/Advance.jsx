  ...
  const exercises = [
    {
      ...
      name: "Chest",
      path: "Chest",
      description: "Elite chest exercises for maximum strength and mass",
      difficulty: "Hard"
    },
    {
      id: 2,
      name: "Back",
      path: "Back",
      description: "Advanced back training for superior development",
      difficulty: "Hard"
    },
    {
      id: 3,
      name: "Legs",
      path: "Legs",
      description: "Expert-level leg workouts for peak performance",
      difficulty: "Hard"
    },
    {
      id: 4,
      name: "Arms",
      path: "Arms",
      description: "Advanced arm training for maximum definition",
      difficulty: "Hard"
    },
    {
      id: 5,
      name: "Shoulders",
      path: "Shoulders",
      description: "Elite shoulder workouts for impressive width",
      difficulty: "Hard"
    },
  ];
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start px-6 sm:px-8 lg:px-16 xl:px-24">
            <div className="max-w-4xl">
              <div className="inline-block px-4 py-2 bg-orange-500/20 backdrop-blur-sm border border-orange-500/30 text-orange-500 text-sm sm:text-base font-M uppercase tracking-wider mb-4 sm:mb-6">
                Level 3 • Advanced 
              </div>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-200 font-M max-w-3xl leading-relaxed">
                Master elite training techniques for peak performance
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 sm:px-8 lg:px-16 xl:px-24 py-16 sm:py-20 lg:py-24">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-gray-400 font-M text-lg sm:text-xl md:text-2xl leading-relaxed max-w-4xl mx-auto">
              Push your limits with advanced exercises designed for experienced athletes seeking maximum results.
            </p>
          </div>
        </div>
                ...
                <div className="relative  overflow-hidden h-72 sm:h-80 group-hover:scale-[1.02] transition-all duration-300 bg-gray-900/40 backdrop-blur-sm border border-gray-700/50 hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/10">
                  ...
                  <div className="relative h-full flex flex-col justify-between p-6 z-10">
                    ...
                    <div className="text-left">
                      <h3 className="text-2xl sm:text-3xl font-One text-white mb-3 group-hover:text-orange-500 transition-colors duration-300">
                        {exercise.name}
                      </h3>
                      ...
                      {/* Call to Action */}
                      <div className="flex items-center text-orange-500 font-M text-sm group-hover:translate-x-1 transition-transform duration-300">
