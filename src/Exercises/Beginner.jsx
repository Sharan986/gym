        ...
        <div className="px-6 sm:px-8 lg:px-16 xl:px-24 pb-16 sm:pb-20 lg:pb-24">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 max-w-6xl mx-auto">
            {exercises.map((exercise) => (
              ...
              >
                <div className="relative rounded-2xl overflow-hidden h-72 sm:h-80 group-hover:scale-[1.02] transition-all duration-300 bg-gray-900/40 backdrop-blur-sm border border-gray-700/50 hover:border-[#48D3A3]/50 hover:shadow-lg hover:shadow-[#48D3A3]/10">
