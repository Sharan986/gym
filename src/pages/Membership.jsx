  ...
  return (
    <div className="bg-[#070915] text-white mb-6 ">
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/3 mx-7 pt-5 mb-2">
          ...
          <ul className="space-y-4 font-M text-lg ">
            {[
              "P.T",
              "ZUMBA",
              "YOGA",
        ...
        <div className="w-80 ml-6 lg:ml-4 md:w-2/3 p-2">
          <style>
            {`
              .slick-slide > div {
                margin: 0 10px;
          ...
          <Slider {...sliderSettings}>
            {slidesData.map((slide, idx) => (
              <div key={idx} className="p-4 border-2 border-[#48D3A3] font-DM transition-transform transform">
