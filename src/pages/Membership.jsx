...
const MembershipSection = () => {
  ...
  return (
    <div className="bg-[#070915] text-white mb-6 pt-14 lg:mx-20">
      <div className="flex flex-col md:flex-col">
        <div className="mx-4 pt-5 mb-2">
          <div className="flex items-center gap-2">
            <Icon />
            <h2 className="text-[#48D3A3] text-2xl md:text-3xl lg:text-4xl font-One">
              OUR MEMBERSHIP
            </h2>
          </div>
          <p className="mb-8 md:text-6xl text-white lg:text-7xl font-One text-3xl">
          ...
          <div className=" px-4">
            ...
            <Slider {...sliderSettings}>
              {slidesData.map((slide, idx) => (
                ...
                >
                  <h2 className="text-[#48D3A3] font-bold mb-2 font-One text-2xl lg:text-4xl">
                    {slide.title}
                  </h2>
                    ...
                    <div>
                      <ol className="font-One text-2xl space-y-2">
                        ...
                        {slide.durations.map((duration, i) => (
                          <li key={i} className="text-gray-300 lg:text-3xl ">
                            {duration}
                          </li>
                        ))}
                      </ol>
                    ...
                    <div>
                      <ol className="font-One text-2xl space-y-2">
                        ...
                        {slide.prices.map((price, i) => (
                          <li key={i} className="text-yellow-400 lg:text-3xl ">
                            {price}
                          </li>
                        ))}
                  ...
                  <Link to="/JoinUs">
                    <button className="bg-yellow-400 lg:text-3xl cursor-pointer text-black font-bold py-2 px-4 w-full hover:bg-yellow-500 transition-colors">
                      BOOK NOW
                    </button>
                  </Link>
                </div>
