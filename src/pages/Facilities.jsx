...
import { CardioIcon, StrengthIcon, YogaPoseIcon, SafetyIcon, AmenitiesIcon, PersonalTrainerIcon } from '../config/PublicIconExports.js';
  ...
  const FacilitiesData = [
    {
      ...
      icon: <CardioIcon className="w-6 h-6 text-[#48D3A3] mr-2" />
    },
    {
      id: 2,
    ...
    },
    {
      ...
      imageUrl: YogaPoseIcon,
      features: ["Yoga Classes", "Zumba Sessions", "HIIT Training", "Certified Instructors"],
      icon: <YogaPoseIcon className="w-6 h-6 text-[#48D3A3] mr-2" />
    },
    {
      id: 4,
    ...
    },
    {
      ...
      icon: <SafetyIcon className="w-6 h-6 text-[#48D3A3] mr-2" />
    },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-center mt-8">
          {FacilitiesData.map((facility) => (
            <article key={facility.id} className="font-One mb-6 p-4 flex flex-col border-2 border-gray-700 hover:border-[#48D3A3]/50 transition-colors">
              <div className="mb-3 w-16 h-16 flex items-center justify-center" style={{ backgroundColor: '#48D3A3' }}>
                <img
