 ...
 const FacilitiesData = [
  {
    ...
    description: "Enhance your cardiovascular fitness with our treadmills, ellipticals, and stationary bikes.",
    imageUrl: "https://framerusercontent.com/images/yDmqlROJtzeBLq417Av3RsaCh8g.svg",
  },
  {
    id: 2,
    title: "Strength Training",
    description: "Build muscle and strength with our free weights, resistance machines, and functional training tools.",
    imageUrl: "https://framerusercontent.com/images/QIxFE5MhwuZBc8t01is4cWpqU.svg",
  },
  {
    id: 3,
    title: "Group Classes",
    description: "Join our diverse group fitness classes, including yoga and HIIT, led by certified instructors.",
    imageUrl: "https://framerusercontent.com/images/K9GUi9VRMjtgqRY8QvQI2o0q54.svg",
  },
  {
    id: 4,
    title: "Personal Training",
    description: "Achieve your fitness goals with personalized workout plans from our certified trainers.",
  ...
  return (
    ...
    <div className="text-white text-xl pt-16 lg:mx-15 mx-8 mb-3">
      <header className="text-2xl font-One w-full text-[#48D3A3] italic  ">
        OUR FACILITIES
      </header>
