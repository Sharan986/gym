          ...
          <div className="mt-20 text-center bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-3xl p-12 border border-gray-700/30">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-gray-300 font-DM">
              <div className="text-center">
                ...
                <p>Increases maximum power output and explosive strength for heavy lifts</p>
              </div>
              <div className="text-center">
                ...
                <p>Enhances high-intensity training performance and workout capacity</p>
              </div>
              <div className="text-center">
                ...
                <p>Increases muscle cell volume and promotes lean muscle mass development</p>
              </div>
            </div>
          </div>
        </div>
