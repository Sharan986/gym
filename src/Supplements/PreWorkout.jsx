        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl font-One text-white mb-8 max-w-4xl mx-auto">
              Explosive Energy & Focus for Maximum Performance
            </p>
            <p className="text-lg md:text-xl font-DM text-gray-300 max-w-5xl mx-auto leading-relaxed">
              Premium pre-workout supplements designed to boost energy, enhance focus, and maximize workout performance. 
              Get the edge you need for intense training sessions and breakthrough results.
            </p>
          </div>
          ...
          <div className="mt-20 text-center bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-3xl p-12 border border-gray-700/30">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-gray-300 font-DM">
              <div className="text-center">
                ...
                <p>Explosive energy and stamina for intense workout sessions</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-[#FCDE3B] to-[#F97316] rounded-full flex items-center justify-center mx-auto mb-4">
                  <img src="/Icons/trainer.webp" alt="Mental Focus" className="w-8 h-8" />
                </div>
                <h4 className="text-xl font-One text-white mb-2">Mental Focus</h4>
                <p>Enhanced focus and mental clarity for better mind-muscle connection</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-[#F97316] to-[#FCDE3B] rounded-full flex items-center justify-center mx-auto mb-4">
                  <img src="/Icons/strength.webp" alt="Performance" className="w-8 h-8" />
                </div>
                <h4 className="text-xl font-One text-white mb-2">Performance</h4>
                <p>Improved strength, endurance, and overall workout performance</p>
              </div>
            </div>
          </div>
        </div>
